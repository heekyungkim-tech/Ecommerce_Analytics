...
def display_rfm_analysis2(df_orders_items, seller_id_input):
    ...
    customer_strategies = {
        "VIP 고객": {
            "추천 전략": ["VIP 전용 혜택 제공 및 독점 상품 제안", "맞춤형 리워드 프로그램 강화", "개인 맞춤형 추천 상품 제공"]
        },
        "프리미엄 고객": {
            "추천 전략": ["고가 상품 추천 및 프리미엄 멤버십 제공", "특별 이벤트 초대 및 혜택 제공", "추가 구매 유도 캠페인 및 상품 추천"]
        },
        "이탈위험 고객": {
            "추천 전략": ["리마인드 마케팅 및 재참여 유도 메시지 전송", "특별 할인 쿠폰 제공 및 재구매 혜택 안내", "맞춤형 재참여 캠페인 제공"]
        },
        "일반 고객": {
            "추천 전략": ["정기적인 마케팅 캠페인 참여 유도", "적당한 보상 프로그램(예: 포인트 적립) 제공", "구매 빈도 증가를 위한 프로모션(예: 세일 정보 제공)"]
        },
        "신규 고객": {
            "추천 전략": ["초기 리텐션 강화를 위한 환영 패키지 제공", "신규 고객 혜택 제공(예: 첫 구매 할인)", "맞춤형 추천 상품 안내 및 할인 행사 초대"]
        }
    }
